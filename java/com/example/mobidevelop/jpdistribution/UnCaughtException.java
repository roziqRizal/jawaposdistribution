...
/**
 * Created by mobiledevelop on 3/24/17.
 */
...
public class UnCaughtException implements UncaughtExceptionHandler {
    ...
    SQLiteDatabase db;
    DataRute dbRute;
    protected Cursor errorreportdatabase;
   ...
   /* private long getAvailableInternalMemorySize(StatFs stat) {
    ...
    public void sendErrorMail(final StringBuilder errorContent) {
        ...
        dbRute = new DataRute(context);
        dbRute.connect();

        db = dbRute.getWritableDatabase();
        errorreportdatabase = db.rawQuery("SELECT * FROM UPLOAD",null);

        builder.setTitle("APP CRASH!!!!");
        builder.create();

        TextView ss = new TextView(context);
        ss.setText(errorContent);
        ss.setTextSize(9);
        ss.setTextColor(Color.parseColor("#000000"));
        ...
        /*builder.setPositiveButton("Report",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "roziqrizal881992@gmail.com" });
